    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-bold text-gray-900 mb-2">ConectaUP</h1>
          <p className="text-gray-600">Plataforma de Gestión de Prácticas Profesionales</p>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          <p className="text-sm text-gray-600 mb-3">Accesos de demostración:</p>
          <div className="space-y-2">
            ...
            >
              <span className="font-medium">Estudiante:</span> juan.perez@estudiante.edu
            </button>
            <button
              onClick={() => quickLogin('maria.garcia@supervisor.edu')}
              className="w-full text-left px-3 py-2 text-sm border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
            >
              <span className="font-medium">Supervisor:</span> maria.garcia@supervisor.edu
            </button>
            <button
